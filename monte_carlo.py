...
class MonteCarlo:
    ...
    @staticmethod
    def gen_couple_by_inversion(inverse_cdf_y: Callable[[Union[float, int]], Union[float, int]], inverse_cdf_x_given_y: Callable[[Union[float, int], Union[float, int]], float], size: int) -> np.ndarray:
        ...
        Args:
            inverse_cdf_y: the pointwise inverse cumulative distribution function of Y (i.e can be computed for a given possible value of Y)
            inverse_cdf_x_given_y: the pointwise inverse cumulative distribution function of X given Y (i.e can be computed for a given possible value of X given Y=y)
                                   the value of X should be the first argument and the value of Y the second argument of this function, subsequent parameters should be 
                                   for example put as default values of the function. 
